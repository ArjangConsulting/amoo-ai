...
cd "$REPO_ROOT"
COMPANION_PORT="$COMPANION_PORT" E2E_PLATFORM="ios" E2E_DEVICE_ID="$TARGET_ID" E2E_APP_ID="com.amoo.companion" swift test --filter "${AMOO_E2E_FILTER:-IntegrationTests}" 2>&1
E2E_EXIT=$?
